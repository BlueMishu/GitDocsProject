  ...
  const Section: React.FC<{
    ...
    return (
      <div className="border border-github-border/40 rounded-lg overflow-hidden mb-6">
        <button
          className={`w-full flex items-center justify-between p-4 text-left bg-github-darker/60 hover:bg-github-darker/80 transition-colors ${
            isOpen ? "border-b border-github-border/40" : ""
          }`}
          onClick={() => toggleSection(id)}
        >
          <div className="flex items-center gap-3">
            <div className="bg-github-accent/20 p-2 rounded-lg">{icon}</div>
            <h3 className="text-lg font-medium text-white">{title}</h3>
          </div>
          <ChevronDown
            className={`h-5 w-5 text-github-muted transition-transform duration-200 ${
  ...
  return (
    <div className="max-w-5xl mx-auto py-12 px-4 sm:px-6">
      <div className="flex flex-col items-start mb-12">
        <div className="flex gap-2 items-center mb-2">
          <div className="bg-github-accent/10 px-2 py-1 rounded-md">
            <span className="text-xs font-medium text-github-accent">
              v1.0.0
            </span>
          </div>
          <div className="flex gap-1">
            ...
            />
            <img
              src="https://img.shields.io/badge/Python-3.8+-green.svg"
              alt="Python 3.8+"
              className="h-5"
            />
            <img
              src="https://img.shields.io/badge/Next.js-13+-000000.svg?logo=next.js&logoColor=white"
              alt="Next.js 13+"
              className="h-5"
            />
            <img
              src="https://img.shields.io/badge/Flask-2.0+-000000.svg?logo=flask&logoColor=white"
              alt="Flask 2.0+"
              className="h-5"
            />
          </div>
        ...
        <p className="text-github-muted text-lg max-w-3xl">
          GitDocs transforms GitHub repositories into polished technical blog
          posts using AI. This documentation will guide you through setting up
      ...
      <Section
        id="overview"
        title="Overview"
        icon={<BookOpen className="h-5 w-5 text-github-accent" />}
      >
        <div className="prose prose-invert prose-github max-w-none">
          ...
          <ul className="space-y-2 text-github-muted">
            <li className="flex items-start gap-2">
              ...
              <span>
                Enter a GitHub repo URL, get a complete technical blog post
              </span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-github-accent font-medium">
              ...
              <span>
                Automatically detects tech stack, parses README, and extracts
            ...
            <li className="flex items-start gap-2">
              ...
              <span>
                Leverages modern language models to create coherent, informative
                technical content
              </span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-github-accent font-medium">
                Clean NextJS Frontend:
              </span>
              <span>
                Modern responsive interface built with NextJS and Tailwind CSS
              </span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-github-accent font-medium">
              ...
              <span>
                Continues to function even when AI services are unavailable
              </span>
            </li>
          </ul>
        </div>
      ...
      <Section
        id="installation"
        title="Installation"
        icon={<Terminal className="h-5 w-5 text-github-accent" />}
      >
        <div className="prose prose-invert prose-github max-w-none">
          ...
          <p className="text-github-muted mb-3">
            Create a{" "}
            <code className="bg-github-darker/50 px-2 py-0.5 rounded text-sm">
              .env
            </code>{" "}
            file in the backend directory with your OpenRouter API key:
          </p>
          <CodeBlock
        ...
        <div className="prose prose-invert prose-github max-w-none">
          ...
          <p className="text-github-muted mb-3">
            ...
            <a
              ...
              className="text-github-accent hover:underline inline-flex items-center gap-1"
            >
              http://localhost:3000 <ExternalLink className="h-3 w-3" />
            </a>
          </p>
          ...
          <div className="bg-github-darker/30 border border-github-border/40 rounded-lg p-4 mt-6">
            ...
            <p className="mt-2 text-github-muted">
              ...
              simultaneously for the application to work properly.
            </p>
          </div>
        </div>
      </Section>
      ...
      <Section
        ...
        icon={<Package className="h-5 w-5 text-github-accent" />}
      >
        <div className="prose prose-invert prose-github max-w-none">
      ...
      <Section
        ...
        icon={
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="h-5 w-5 text-github-accent"
            viewBox="0 0 20 20"
            fill="currentColor"
          >
            <path
